...
const handleClick=()=>{
  ...
  axios.post('http://localhost:5000/text/generate', requestBody, {
  headers: {
...
<Box border='2px' borderColor='gray.400' w="64%" h="100vh" pl="5%" /* bgColor="bisque" */>
      ...
      <Flex mt="2%" className='main'>
       ...
       <Box>
       <Input value={topic} onChange={(e)=>setTopic(e.target.value)} placeholder='Specify the Topic' />
       </Box>
       <Box>
  ...
  <option value='hindi'>Hindi</option>
       ...
       <Button colorScheme='green' onClick={handleClick}>Explain</Button>
      </Flex>
